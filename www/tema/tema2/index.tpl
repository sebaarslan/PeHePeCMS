          ...
          <td width="100%">
            <table cellspacing="0" cellpadding="0" width="100%" border="0">
              ...
              <table class="ana" cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  <td width="100%" valign="top" align="center" class="ortaalan" style="padding-left:10px">
                  ...
                  <td valign="top" width="15" class="ortabosluk"><img height="18" alt="" src="resim/bosluk.gif" width="18" /></td>
                  <td valign="top" width="180" align="center" class="solmenu" style="border-left:dashed 2px #ff6600;">
                    <table cellspacing="0" cellpadding="0" width="180" border="0">
                      ...
                      <tr>
                        ...
                        <td valign="top" align="middle">
												  <table cellspacing="0" cellpadding="4" width="100%" border="0">
													  <tr>
                              <td valign="top" align="left">{UYELER_DOGUM_GUNU}</td>
														</tr>
													</table> 
												</td>
											</tr>
